...
GameObject* sphere = new Sphere(1.0f, vector3(0, -1, 0), Colors3f::Green, UserInput::isTrue, UsingRigidBody3D::SolidSphere, ShowDetails::isFalse);
...
GameObject* sphere3 = new Sphere(1.0f, vector3(0, 5, 0), Colors3f::Green, UserInput::isFalse, UsingRigidBody3D::SolidSphere, ShowDetails::isFalse);
GameObject* sphere4 = new Sphere(1.0f, vector3(2, 0, 0), Colors3f::Green, UserInput::isFalse, UsingRigidBody3D::non, ShowDetails::isFalse);
