...
namespace Colors4f
{
	const glm::vec4 Red = glm::vec4(1.0f, 0.0f, 0.0f, 0.0f);
	const glm::vec4 White = glm::vec4(1.0f, 1.0f, 1.0f, 0.0f);
	const glm::vec4 Yellow = glm::vec4(1.0f, 1.0f, 0.0f, 0.0f);
	const glm::vec4 Purple = glm::vec4(1.0f, 0.0f, 1.0f, 0.0f);
	const glm::vec4 Light_blue = glm::vec4(0.0f, 1.0f, 1.0f, 1.0f);
	const glm::vec4 Orange_brown = glm::vec4(1.0f, 0.5f, 0.0f, 0.0f);
}