...
public:
	...
	Circle(float mas, vector3 pos, vector3 col, bool KeyboardUse, float rad, int UsingRigidBody2D, bool ShowingDetailsOnObject);// Contructuor using GameObject details / Else
	~Circle();									// Destructor
